...
class AuthorizationTest {
    ...
    public void testToFix() {
        assertTrue(authorization.auth(new User("Cat", "113")));
    }

    @Test
    public void testAuthOK() {
        assertTrue(authorization.auth(new User("fifa", "6")));
    }

    @Test
    public void testAuthFail() {
        assertFalse(authorization.auth(new User("Cat", "null")));
    }

    @Test
    public void testAuthFail2() {
        assertFalse(authorization.auth(new User("null", "113")));
    }


    @Test
    public void testAuthFail3() {
        assertFalse(authorization.auth(new User("", "113")));
    }
    ...
    public void loadTest() {
        ...
        authorization.auth(new User("Cat", "113"));//X
    ...
    public void testToFix2() {
        User user = new User("Cat", "113");
        assertTrue(authorization.auth(user));
        Hacker hacker = new Hacker("Cat", "113");
